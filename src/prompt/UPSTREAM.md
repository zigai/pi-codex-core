...
The model-specific prompt assets in this directory were copied from `codex-rs/models-manager/models.json` and verified against OpenAI Codex tag `rust-v0.147.0`, commit `be6e8eac029b183056b7e4402879f15d2c85f61b` (2026-08-06).
