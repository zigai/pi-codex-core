...
The model-specific prompt assets in this directory were copied from `codex-rs/models-manager/models.json` at OpenAI Codex tag `rust-v0.145.0`, commit `25af12f7e61572b0bc18ddb1008be543b91519b0` (2026-07-21).
...
- `codex-gpt-5.6-sol.md`: shared `gpt-5.6-sol`, `gpt-5.6-terra`, and `gpt-5.6-luna` `base_instructions`, source-text SHA-256 `cbefa6b0bede0e332d957fca70ccacf9f12f4c0ecdf81b819e5cbe1a3b16e265`
- `codex-gpt-5.6-terra-luna.md`: the same shared GPT-5.6 `base_instructions`, source-text SHA-256 `cbefa6b0bede0e332d957fca70ccacf9f12f4c0ecdf81b819e5cbe1a3b16e265`
